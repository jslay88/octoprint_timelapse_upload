...
plugin_identifier = "timelapse_upload"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_timelapse_upload"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "octoprint_timelapse_upload"
...
# module
plugin_description = """Upload Timelapse video to a variety of cloud storage providers."""
...
plugin_url = "https://github.com/jslay88/octoprint_timelapse_upload"
